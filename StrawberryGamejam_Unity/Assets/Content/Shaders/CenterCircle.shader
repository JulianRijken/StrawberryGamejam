	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_30_0 = ( _EdgeWith * 2.0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float clampResult35 = clamp( ( 1.0 - ( temp_output_30_0 / ase_objectScale.x ) ) , 0.0 , 1.0 );
				float clampResult36 = clamp( ( 1.0 - ( temp_output_30_0 / ase_objectScale.y ) ) , 0.0 , 1.0 );
				float2 appendResult11_g14 = (float2(clampResult35 , clampResult36));
				...
				float4 appendResult19 = (float4(( tex2D( _MainTex, uv_MainTex ) * ( 1.0 - saturate( ( ( 1.0 - temp_output_17_0_g14 ) / fwidth( temp_output_17_0_g14 ) ) ) ) ).rgb , saturate( ( ( 1.0 - temp_output_17_0_g15 ) / fwidth( temp_output_17_0_g15 ) ) )));
...
/*ASEBEGIN
Version=18933
1920;0;1920;1019;1999.109;165.2111;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;20;-1610.169,158.9766;Inherit;False;Property;_EdgeWith;EdgeWith;1;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ObjectScaleNode;31;-1350.943,334.6347;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-1316.834,192.761;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;33;-1090.505,390.274;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;32;-1096.918,174.5511;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;34;-936.7396,179.928;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;37;-940.0233,391.1786;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;36;-742.8191,369.7879;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;35;-744.8191,185.7879;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;16;362.5957,104.9773;Inherit;True;Ellipse;-1;;15;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
WireConnection;17;7;35;0
WireConnection;17;9;36;0
...
ASEEND*/
//CHKSM=9F0DBFE6C15DD8F41A7177BBC3C045EF37ABD8DB