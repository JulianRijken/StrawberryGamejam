	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult11_g15 = (float2(1.0 , 1.0));
				float temp_output_17_0_g15 = length( ( (IN.texCoord0.xy*2.0 + -1.0) / appendResult11_g15 ) );
				...
				float2 appendResult11_g14 = (float2(clampResult127 , clampResult128));
				...
				float4 appendResult50 = (float4(tex2D( _MainTex, uv_MainTex ).rgb , ( ( saturate( ( ( 1.0 - temp_output_17_0_g15 ) / fwidth( temp_output_17_0_g15 ) ) ) - saturate( ( ( 1.0 - temp_output_17_0_g14 ) / fwidth( temp_output_17_0_g14 ) ) ) ) * floor( ( ( _FillAngle / 360.0 ) + (0.0 + (atan2( break17.x , break17.y ) - ( PI * -1.0 )) * (1.0 - 0.0) / (PI - ( PI * -1.0 ))) ) ) )));
...
/*ASEBEGIN
Version=18933
1920;0;1920;1019;1154.556;987.0309;1.757982;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;121;-2259.874,-685.1027;Inherit;False;2552.739;701.2682;Get Edge;13;35;94;70;71;76;75;69;31;32;34;127;128;132;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-1600.132,-382.2008;Inherit;False;Property;_EdgeWith;EdgeWith;0;0;Create;True;0;0;0;False;0;False;0.47;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;-1372.317,-368.4181;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;-1425.799,-210.1783;Inherit;False;Property;_ExtraEdgeWith;ExtraEdgeWith;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ObjectScaleNode;70;-1185.426,-208.5444;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;131;-1219.799,-342.1783;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;76;-924.988,-152.9051;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;71;-931.401,-368.628;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;69;-771.2224,-363.2511;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;75;-774.5061,-152.0005;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;128;-577.3018,-173.3912;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;127;-579.3018,-357.3912;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;32;-518.6674,-628.6028;Inherit;True;Ellipse;-1;;15;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;1;False;9;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;28;-17.46966,449.0269;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;31;-358.8432,-323.4808;Inherit;True;Ellipse;-1;;14;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=02887B7E0FFA95729CFB5BE8523C4ED7F1959EB6