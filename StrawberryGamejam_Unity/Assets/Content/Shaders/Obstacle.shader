	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_94_0 = ( _EdgeWith * 2.0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float clampResult127 = clamp( ( 1.0 - ( temp_output_94_0 / ase_objectScale.x ) ) , 0.0 , 1.0 );
				float clampResult128 = clamp( ( 1.0 - ( temp_output_94_0 / ase_objectScale.y ) ) , 0.0 , 1.0 );
				...
				float4 appendResult50 = (float4(tex2D( _MainTex, uv_MainTex ).rgb , ( ( saturate( ( ( 1.0 - temp_output_17_0_g17 ) / fwidth( temp_output_17_0_g17 ) ) ) - saturate( ( ( 1.0 - temp_output_17_0_g16 ) / fwidth( temp_output_17_0_g16 ) ) ) ) * floor( ( ( _FillAngle / 360.0 ) + (0.0 + (atan2( break17.x , break17.y ) - ( PI * -1.0 )) * (1.0 - 0.0) / (PI - ( PI * -1.0 ))) ) ) )));
...
/*ASEBEGIN
Version=18933
1920;0;1920;1019;953.8335;431.0046;1.242124;True;False
Node;AmplifyShaderEditor.CommentaryNode;119;-3289.665,985.4631;Inherit;False;202;185;Half The Fill Angle;1;118;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;130;-3292.683,678.5223;Inherit;False;Constant;_RotationOffset;RotationOffset;4;0;Create;True;0;0;0;False;0;False;180;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-3781.809,241.0936;Inherit;False;Property;_FillAngle;FillAngle;1;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-3256.779,565.0636;Inherit;False;Property;_Rotation;Rotation;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;129;-2982.683,659.5223;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;118;-3239.665,1035.463;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-1584.914,-383.5323;Inherit;False;Property;_EdgeWith;EdgeWith;0;0;Create;True;0;0;0;False;0;False;0.47;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ObjectScaleNode;70;-1364.208,-206.8758;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;-1357.099,-369.7496;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;71;-1110.183,-366.9595;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;76;-1103.77,-151.2365;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PiNode;20;-793.1739,716.6719;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;75;-953.2883,-150.3319;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;69;-950.0044,-361.5826;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;127;-758.0842,-355.7227;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;128;-756.0842,-171.7226;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;31;-537.6255,-321.8123;Inherit;True;Ellipse;-1;;16;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;39;527.6072,-592.3585;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=40C59FF0EAD340662F488DE767863AC54B06A22C