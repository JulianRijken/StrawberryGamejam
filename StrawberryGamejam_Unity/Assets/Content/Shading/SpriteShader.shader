	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 appendResult50 = (float4(tex2DNode39.r , tex2DNode39.g , tex2DNode39.b , ( ( saturate( ( ( 1.0 - temp_output_17_0_g7 ) / fwidth( temp_output_17_0_g7 ) ) ) - saturate( ( ( 1.0 - temp_output_17_0_g8 ) / fwidth( temp_output_17_0_g8 ) ) ) ) * floor( ( _FillAlpha + (0.0 + (atan2( break17.x , break17.y ) - ( PI * -1.0 )) * (1.0 - 0.0) / (PI - ( PI * -1.0 ))) ) ) )));
...
/*ASEBEGIN
Version=17700
-1920;0;1920;1019;1405.526;530.2639;1;False;False
Node;AmplifyShaderEditor.RangedFloatNode;29;-3037.272,-105.5285;Inherit;False;Property;_FillAlpha;FillAlpha;1;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RotatorNode;10;-2087.727,203.6434;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-1132.925,-387.3007;Inherit;False;Property;_EdgeSize;EdgeSize;0;0;Create;True;0;0;False;0;0.97;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ObjectScaleNode;70;-1132.219,-312.6442;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;71;-881.1957,-423.7281;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;76;-874.7828,-208.0047;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;75;-711.3008,-211.1002;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;69;-721.017,-418.3511;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;79;-504.5149,-413.9638;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-250.261,-27.55655;Inherit;False;Constant;_EllipseFull;EllipseFull;1;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;80;-500.5149,-215.9638;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;31;-73.5499,-311.0039;Inherit;True;Ellipse;-1;;8;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;28;27.84893,364.4829;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;32;-70.9566,-66.59632;Inherit;True;Ellipse;-1;;7;3ba94b7b3cfd5f447befde8107c04d52;0;3;2;FLOAT2;0,0;False;7;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=EF2378FCF25071F76AFA5EA02FA413081306605F